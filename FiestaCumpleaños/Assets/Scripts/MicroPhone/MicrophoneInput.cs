...
public class MicrophoneInput : MonoBehaviour
{
    ...
    void Start()
    {
		...
		microphone = options[PlayPrefsManager.GetMicrophone()];
		minThreshold = PlayPrefsManager.GetThreshold();
	...
	public void UpdateMicrophone()
	{
		...
		audioSource.clip = Microphone.Start(microphone, true, 40, audioSampleRate);
