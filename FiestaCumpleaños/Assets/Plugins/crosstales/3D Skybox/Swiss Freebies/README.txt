# 3D Skybox PRO - Swiss Freebies 2019.1.1
...
For example scenes, please see the "Demo"-folder.



## Important
Texture import size is set to 2048x2048 pixels to speed up the import.
